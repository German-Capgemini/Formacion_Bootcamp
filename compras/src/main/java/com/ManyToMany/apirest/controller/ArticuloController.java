...
public class ArticuloController {
	...
	public ResponseEntity<?> updateClienteExcepciones(@RequestBody Articulo articulo, @PathVariable Long id) {
		...
		if (articuloActual == null) {
			...
			response.put("mensaje",
					"Error: no se pudo editar, el articulo con ID: " + id.toString() + "no existe en la BBDD");
			return new ResponseEntity<Map<String, Object>>(response, HttpStatus.NOT_FOUND);
	...
	public ResponseEntity<List<Articulo>> getArticuloByName(@RequestParam String nombre) {
		return new ResponseEntity<List<Articulo>>(servicio.findByNombre(nombre), HttpStatus.OK);
	}
